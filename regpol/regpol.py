...
@click.command()
@click.argument('filename', metavar='FILE')
@click.option('--raw-data', metavar='INDEX', type=int, help='print raw data for entry at INDEX')
def cli(filename, raw_data):
